...
@interface PanoMulticastDelegate ()
{
...
@interface PanoMulticastDelegateEnumerator ()
{
    NSUInteger numNodes;
...
@implementation PanoMulticastDelegate
...
{
    return [[PanoMulticastDelegateEnumerator alloc] initFromDelegateNodes:delegateNodes];
}
...
@implementation PanoMulticastDelegateEnumerator
